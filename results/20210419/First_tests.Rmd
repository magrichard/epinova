...
library(ggplot2)
=======
>>>>>>> 2c9182e9240c7df3025bc8422ed955dfcb9a4931
...
## Volcano Plot
<<<<<<< HEAD
```{r echo=T,eval=T,results="hold",label="Preparing data for volcano plots"}
=======
...
<<<<<<< HEAD
```{r echo=T,eval=T,results="hold",label="Volcano plotting data: C versus D"}
=======
```{r echo=T,eval=T,results="hold",label="Volcano plotting data"}
>>>>>>> 2c9182e9240c7df3025bc8422ed955dfcb9a4931
