...
cond = df$conditions
levels(cond) = list(C = c("C1", "C2", "C3", "C4", "C5", "C6", "C7", "C8"), D = c("D1", "D2", "D3", "D4", "D5", "D6", "D7", "D8"))
plot = ggplot(df, aes(x=probes, y=value, color=cond)) + geom_point()
plot

bed_ewas$beta_C = as.factor(bed_ewas$beta_C)
bed_ewas$beta_D = as.factor(bed_ewas$beta_D)

ggplot(bed_ewas[idx_probes,], aes(x=probes), color=c(beta_C, beta_D))+geom_point(aes(y=beta_C), colour="red") +geom_point(aes(y=beta_D),  colour="blue")
